...
const Settings = ({ navigation }) => {
  ...
  //----------------------------------state for model to change langue:
  ...
  const accountItems = [
    ...
    { icon: "person-outline", text: t("Profile"), action: NavigateToprofile },
  ...
  const actionsItems = [
    ...
    isLoggedIn?
    { icon: "logout", text: t("Se déconnecter"), action: () => handleLogOut() }
